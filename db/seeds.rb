...
avatar1 = Avatar.create(avatar_style: 'Circle', top: 'NoHair', accessories: 'Blank', hair_color: '', hat_color: '', facial_hair: 'BeardMajestic', facial_hair_color: 'BrownDark', clothes: 'BlazerShirt', color_fabric: '', eyes: 'Default', eyebrow: 'Angry', mouth: 'Disbelief', skin: 'Brown', user_id: user1.id)
avatar2 = Avatar.create(avatar_style: 'Circle', top: 'ShortHairShortFlat', accessories: 'Red', hair_color: '', hat_color: '', facial_hair: 'BeardMajestic', facial_hair_color: 'BrownDark', clothes: 'BlazerShirt', color_fabric: '', eyes: 'Default', eyebrow: 'Angry', mouth: 'Disbelief', skin: 'Brown', user_id: user2.id)
avatar3 = Avatar.create(avatar_style: 'Circle', top: 'ShortHairShortFlat', accessories: 'Brown', hair_color: '', hat_color: '', facial_hair: 'BeardMajestic', facial_hair_color: 'BrownDark', clothes: 'BlazerShirt', color_fabric: '', eyes: 'Default', eyebrow: 'Angry', mouth: 'Disbelief', skin: 'Brown', user_id: user3.id)
avatar4 = Avatar.create(avatar_style: 'Circle', top: 'ShortHairShortFlat', accessories: 'SilverGrey', hair_color: '', hat_color: '', facial_hair: 'BeardMajestic', facial_hair_color: 'BrownDark', clothes: 'BlazerShirt', color_fabric: '', eyes: 'Default', eyebrow: 'Angry', mouth: 'Disbelief', skin: 'Brown', user_id: user4.id)
avatar5 = Avatar.create(avatar_style: 'Circle', top: 'ShortHairShortFlat', accessories: 'Blonde', hair_color: '', hat_color: '', facial_hair: 'BeardMajestic', facial_hair_color: 'BrownDark', clothes: 'BlazerShirt', color_fabric: '', eyes: 'Default', eyebrow: 'Angry', mouth: 'Disbelief', skin: 'Brown', user_id: user5.id)
avatar6 = Avatar.create(avatar_style: 'Circle', top: 'ShortHairShortFlat', accessories: 'Black', hair_color: '', hat_color: '', facial_hair: 'BeardMajestic', facial_hair_color: 'BrownDark', clothes: 'BlazerShirt', color_fabric: '', eyes: 'Default', eyebrow: 'Angry', mouth: 'Disbelief', skin: 'Brown', user_id: user6.id)
